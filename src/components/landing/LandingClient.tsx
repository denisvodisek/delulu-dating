...
function specimenStripClasses(tier: SavedRun["tier"]) {
  ...
  return "bg-lab-secondary text-white";
}
...
export default function LandingClient() {
  ...
  return (
    <main className="pt-20">
      {/* Hero */}
      <section className="grid min-h-[calc(100dvh-5rem)] w-full grid-cols-1 overflow-hidden border-b border-lab-outline-variant md:grid-cols-2 md:grid-rows-1">
        <div className="flex min-h-0 flex-col border-b border-lab-outline-variant bg-lab-surface-container-lowest/80 p-4 md:border-r md:border-b-0 md:p-16">
          <div className="mt-6 md:mt-10">
            <h1 className="font-lab-display mb-10 text-5xl leading-none font-extrabold tracking-tight uppercase text-lab-on-surface md:text-7xl md:leading-[0.95] lg:text-[84px] lg:leading-[90px]">
              {t("heroTitle1")}
              <br />
            ...
            <div className="max-w-md space-y-8">
              ...
              <Link
                href="/quiz"
                className="group font-lab-mono text-lab-mono relative inline-flex items-center border-2 border-lab-on-surface bg-lab-primary px-12 py-6 text-xs font-bold tracking-widest text-lab-on-primary uppercase shadow-[4px_4px_0_0_rgba(10,10,11,1)] transition-all duration-200 hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[2px_2px_0_0_rgba(10,10,11,1)] active:translate-x-1 active:translate-y-1 active:shadow-none"
              >
      ...
      {/* Process */}
      <section className="grid grid-cols-1 divide-y divide-lab-outline-variant border-b border-lab-outline-variant md:grid-cols-3 md:divide-x md:divide-y-0">
        {(
          [
          ...
          <div
            key={step}
            className="group flex flex-col gap-6 bg-lab-surface-container-lowest p-4 transition-colors duration-200 hover:bg-lab-surface md:p-16"
          >
            <div className="flex items-start justify-between">
              <span className="font-lab-display text-6xl leading-none text-lab-outline-variant transition-colors group-hover:text-lab-on-surface">
                {step}
              </span>
              <span className="material-symbols-outlined text-4xl text-lab-on-surface">{icon}</span>
            </div>
            <div>
              <h3 className="font-lab-mono text-lab-mono mb-4 text-xs font-semibold tracking-widest text-lab-on-surface uppercase">
                {t(titleKey)}
              </h3>
      ...
      >
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12 lg:gap-[var(--spacing-lab-gutter)]">
          <div className="lg:col-span-4">
            ...
            <div className="rounded-xl border border-lab-outline-variant bg-lab-surface-container-lowest p-6">
              ...
              recent.map((run) => {
                ...
                return (
                  <button
                    ...
                    type="button"
                    onClick={() => openRun(run)}
                    className="group flex w-full cursor-pointer flex-col overflow-hidden rounded-xl border border-lab-outline-variant bg-lab-surface-container-lowest text-left shadow-sm transition-all hover:border-lab-on-surface/25 hover:shadow-md md:flex-row"
                  >
                    <div
                      className={cn(
                    ...
                    <div className="bg-lab-surface flex flex-1 items-center justify-between gap-4 p-6">
                      ...
                      <span className="material-symbols-outlined shrink-0 text-lab-outline transition-colors group-hover:text-lab-on-surface">
                        arrow_forward
                      </span>
                    </div>
                  </button>
