...
export function CtaR3fBackdrop() {
  return (
    <div className="pointer-events-none absolute inset-0 opacity-[0.38] md:opacity-[0.46]">
      <Canvas
      ...
      >
        ...
        <pointLight position={[5, 4, 6]} intensity={0.85} color="#30c7ff" />
        <pointLight position={[-4, -2, 4]} intensity={0.55} color="#ff8add" />
        <CandyOrbit />
      </Canvas>
    </div>
  );
